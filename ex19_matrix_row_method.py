...
PURPOSE
    ...
    Added for Exercise 19:
    The method row() in the takes the index as an
    argument and returns the corresponding row
    of the matrix.
...
class Matrix:
    ...
    def row(self, row_int):
        return self.matrix[row_int]
...
print('Test 2'.center(30, '-'))
row_int = 2
print(f'This is in row {row_int}')
print(matrix_obj.row(row_int))
if matrix_obj.row(row_int) == ['8', '9']:
    print('Test passed')
else:
    print('Test failed')